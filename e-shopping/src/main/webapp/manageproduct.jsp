...
%>
						...
						<div class="collapse navbar-collapse menu--shylock"
							...
							<ul class="nav navbar-nav menu__list">
								...
								<li class="active menu__item menu__item--current"><a
									class="menu__link" href="manageproduct.jsp">Manage Product</a></li>
								<li class="menu__item dropdown"><a class="menu__link"
									href="#" class="dropdown-toggle" data-toggle="dropdown"><%=sr.getName()%>
										<b class="caret"></b></a>
	...
	<div class="new_arrivals_agile_w3ls_info">
		<div class="container">
			...
			<%int id = sr.getId();
			List<Product_seller> list = product_dao.getProductsbyId(id);
			%>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
								<a href="product_update.jsp?id=<%=pr.getPid()%>">Edit</a>		
								
						
									</div>
									<div class="info-product-price">
								<a href="product_update.jsp?id=<%=pr.getPid()%>">Delete</a>		
