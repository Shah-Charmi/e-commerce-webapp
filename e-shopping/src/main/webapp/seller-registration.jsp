...
<div class="page-head_agile_info_w3l">
   ...
   <!--/contact-->
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Seller Registration <span>Form</span></h4>
						<form action="Actioncontrol" method="post" align="center" enctype="multipart/form-data">
						<div class="styled-input agile-styled-input-top">
							...
							<div class="styled-input">
								<input type="number" name="gstnumber" required="">
