...
<div class="page-head_agile_info_w3l">
   ...
   <!--/contact-->
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Product Update <span>Form</span></h4>
						<%int id = Integer.parseInt(request.getParameter("id"));%>
						<%Product_seller p = product_dao.getProductbyId(id); %>
						<form action="ProductController" method="post" align="center" enctype="multipart/form-data">
					 <div class="styled-input agile-styled-input-top">
						...
						<div class="styled-input agile-styled-input-top">
								...
								<img alt="" src="images/<%=p.getPimage() %>" height=100px width=100px>
							...
							<div class="styled-input agile-styled-input-top">
								<input type="text" name="pcost"  value="<%=p.getPcost()%>">
