<%@page import="com.Model.Customer_reg"%>
...
<%
	...
	if(session.getAttribute("msg")!=null){
		 cr  = (Customer_reg)session.getAttribute("msg");
	}
	else{
...
<div class="page-head_agile_info_w3l">
   ...
   <!--/contact-->
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Customer Registration <span>Form</span></h4>
						<form action="Actioncontrol_customerreg" method="post" >
						<div class="styled-input agile-styled-input-top">
								<input type="text" name="id" value="<%=cr.getId()%>" >
								<label>Id</label>
								<span></span>
							</div>
							<div class="styled-input agile-styled-input-top">
								<input type="text" name="name" value="<%=cr.getName()%>" >
								<label>Name</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="email" name="email" value="<%=cr.getEmail() %>" > 
								<label>Email</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="password" name="password" value="<%=cr.getPassword() %>"  > 
								<label>Password</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="text" name="mobilenumber" value="<%=cr.getMobileno() %>" >
								<label>Mobile Number</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="address" value="<%=cr.getAddress() %>"  >
								<label>Address</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="pincode" value="<%=cr.getPincode() %>"  >
								<label>Pincode</label>
								<span></span>
							</div>	 
