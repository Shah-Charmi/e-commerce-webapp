<%@page import="com.Model.Product_seller"%>
...
%> --%>
			...
			<div class="top_nav_left">
				<nav class="navbar navbar-default">
					<div class="container-fluid">
					   ...
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown"><%=cr.getName()%> <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="customer_profile.jsp">Profile</a></li>
									<li><a href="customer_profile.jsp">Change password</a></li>
	...
	<div class="new_arrivals_agile_w3ls_info">
		<div class="container">
			...
			<% 
			List<Product_seller> list=customerdao.getallProducts();
			%>
			<%for(Product_seller pr : list){
				%>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="images/<%=pr.getPimage() %>" alt="" class="pro-image-front">
									<img src="images/<%=pr.getPimage() %>" alt="" class="pro-image-back">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html"><%=pr.getPname() %></a>
									</h4>
									<div class="info-product-price">
										<span class="item_price"><%=pr.getPcost() %></span>
