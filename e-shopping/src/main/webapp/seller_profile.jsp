...
<body>
	...
	if (session.getAttribute("msg") != null) {
		sr = (Seller_reg) session.getAttribute("msg");
	} else {
						...
						<div class="collapse navbar-collapse menu--shylock"
							...
							<ul class="nav navbar-nav menu__list">
								...
								<li class="menu__item dropdown"><a class="menu__link"
									href="#" class="dropdown-toggle" data-toggle="dropdown">Registration
										<b class="caret"></b>
								</a>
								...
								<li class="menu__item dropdown"><a class="menu__link"
									href="#" class="dropdown-toggle" data-toggle="dropdown">Login
										<b class="caret"></b>
								</a>
									<ul class="dropdown-menu agile_short_dropdown">
	...
	<ul
		class="social-nav model-3d-0 footer-social w3_agile_social two contact">
		<li class="share">SHARE ON :</li>
		<li><a href="#" class="facebook">
				<div class="front">
					<i class="fa fa-facebook" aria-hidden="true"></i>
		...
		<div class="col-md-6 contact-form">
			<h4 class="white-w3ls">
				Seller Registration <span>Form</span>
			</h4>
			<form action="Actioncontrol" method="post" align="center"
				enctype="multipart/form-data">
				<div class="styled-input agile-styled-input-top">
					<input type="text" name="id" value="<%=sr.getId()%>"> <label>Id</label>
					<span></span>
				</div>
				<div class="styled-input agile-styled-input-top">
					<input type="file" name="image" value="<%=sr.getImage()%>">
				</div>
				<div class="styled-input agile-styled-input-top">
					<input type="text" name="name" value="<%=sr.getName()%>">
					<label>Name</label> <span></span>
				</div>
				<div class="styled-input">
					<input type="email" name="email" value="<%=sr.getEmail()%>">
					<label>Email</label> <span></span>
				</div>
				<div class="styled-input">
					<input type="password" name="password"
						value="<%=sr.getPassword()%>"> <label>Password</label> <span></span>
				</div>
				<div class="styled-input">
					<input type="text" name="mobilenumber"
						value="<%=sr.getMobileno()%>"> <label>Mobile
						Number</label> <span></span>
				</div>
				<div class="styled-input">
					<input type="text" name="address" value="<%=sr.getAddress()%>">
					<label>Address</label> <span></span>
				</div>

				<div class="styled-input">
					<input type="text" name="gstnumber" value="<%=sr.getGstnumber()%>">
					<label>GST Number </label> <span></span>
				</div>
