			...
			<div class="top_nav_left">
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock"
							...
							<ul class="nav navbar-nav menu__list">
								...
								<li class="menu__item dropdown"><a class="menu__link"
									href="product_upload.jsp" >Upload product
										
								</a>
									</li>
									<li class="menu__item dropdown"><a class="menu__link"
									href="manageproduct.jsp" >Manage product
						...
						<li class=" menu__item"><a class="menu__link"
									href="seller-login.jsp">Logout</a></li>
									<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown"><%=sr.getName() %> <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="seller_profile.jsp">Profile</a></li>
									<li><a href="seller_profile.jsp">Change password</a></li>
									<li><a href="seller-login.jsp">Logout</a></li>
								</ul>
								</li>
								</ul>
